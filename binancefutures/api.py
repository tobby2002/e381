...
from binancefutures.error import ClientError, ServerError
from binancefutures.lib.utils import get_timestamp
from binancefutures.lib.utils import cleanNoneValue
from binancefutures.lib.utils import encoded_string
from binancefutures.lib.utils import check_required_parameter
from binancefutures.lib.authentication import hmac_hashing, rsa_signature
        ...
        self.session.headers.update(
            {
                ...
                "User-Agent": "binancefutures-connector/" + __version__,
                "X-MBX-APIKEY": key,
            }
        )
