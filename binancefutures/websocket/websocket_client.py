...
from binancefutures.websocket.binance_socket_manager import BinanceSocketManager
...
class BinanceWebsocketClient(BinanceSocketManager):
    ...
    def live_subscribe(self, stream, id, callback, **kwargs):
        ...
        - UM Futures: wss://fstream.binancefutures.com/ws
        - UM Futures testnet: wss://stream.binancefuture.com/ws
        - CM Futures: wss://dstream.binancefutures.com/ws
    ...
    def instant_subscribe(self, stream, callback, **kwargs):
        ...
        wss://fstream.binancefutures.com/ws/btcusdt@bookTicker
        wss://fstream.binancefutures.com/stream?streams=btcusdt@bookTicker/bnbusdt@bookTicker
