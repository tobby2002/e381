...
def backtest_trade45(df, symbol, fcnt, longshort, df_lows_plot, df_highs_plot, wavepattern, trade_info, idx, wavepattern_l, wavepattern_tpsl_l, wave_cycle):
    w = wavepattern
                        ...
                        for rule in rules_to_check:
                            if wavepattern.check_rule(rule):
                                ...
                                if wave_cycle:
                                    ...
                                    trade_info, trade_flg = backtest_trade45(df_all, symbol, fc, longshort,
                                                                             df_lows_plot, df_highs_plot, wavepattern,
                                                                             trade_info, i, wavepattern_l,
                                                                             wavepattern_tpsl_l, wave_cycle)
