...
with open('../_run_bk_success/e381run/config_trade.json', 'r') as f:
    config = json.load(f)
                    ...
                    if (wavepattern.idx_end - wavepattern.idx_start + 1) >= fc / 2:
                        for rule in rules_to_check:
                            if wavepattern.check_rule(rule):
                                ...
                                logger.info('Impulse found!', wave_opt.values)
                                end = waves[4].idx_end
                                ...
                                for new_option_correction in waveoptions_down.options_sorted:
                                    ...
                                    if wave_abcs:
                                        ...
                                        check_rule_flg = wavepattern.check_rule(correction) if longshort else wavepattern.check_rule(downcorrection)
                                        if check_rule_flg:
...
if __name__ == '__main__':
    ...
    |_   _|           | (_)             | ___ \     | |
      ...
      | | '__/ _` |/ _` | | '_ \ / _` | | ___ \/ _ \| __|
      | | | | (_| | (_| | | | | | (_| | | |_/ / (_) | |_
      \_/_|  \__,_|\__,_|_|_| |_|\__, | \____/ \___/ \__| v0.2 with cycle
                                  __/ |
                                 |___/
